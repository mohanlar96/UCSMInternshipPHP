...
<div class="container-fluid">
  ...
  <div class="row" > 
    ...
    <form id="searchName" class="form-horizontal" action="ferry_update_search.php" method="post" role="form">
...
<script type="text/javascript" src="js/ferry_update.js"></script> 
