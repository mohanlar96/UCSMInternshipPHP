...
<div class="container-fluid" id="award">
	...
	<div class="col-md-4 col-xs-3">
        <br>
     <form class="form-horizontal" role="form" method="GET" action="sponsorlist.php">
    <div class="col-md-6">
	...
	<!-- <div align="center">
	<button type="button" class="btn btn-primary" onclick="window.location='awardsponsorlist.php'">Back</button>   
	</div> -->
</div>
