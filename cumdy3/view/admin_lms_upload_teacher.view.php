...
<div class="row">
  ...
  <div class="alert alert-success"  style="margin-top:20px;">
      <?=$bar?>
		...
		<form action="admin_lms_upload1.php?<?=$dataString?>" role="form" method="post"
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="name" style="text-align: left;">
      File Name</label>
      <div class="col-sm-3">          
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="due"
       style="text-align: left;">Due Date</label>
      <div class="col-sm-3">          
    ...
    <div class="form-group" >
      <label class="control-label col-sm-2"" for="file" style="text-align: left;">
      File</label>
      <div class="col-sm-3">          
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <a href="admin_lms_viewAnswer_teacher.php?<?=$dataString?>">
