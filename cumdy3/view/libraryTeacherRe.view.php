...
<div class="row">
 <form class="form-horizontal" role="form" method="post" action="libraryTeacherRet.php">
    <div class="form-group">
     ...
     <div class="form-group">
      <label class="control-label col-sm-2" for="uid">Teacher ID:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" name="tid" id="uid" placeholder="Enter Teacher ID" required="Teacher ID">
      </div>
    </div>
  ...
  <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="return_date" id="return" placeholder="Enter Return Date" class="Date" required="Return Date">
      </div>
    </div>
       
<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-4" align="center">
        <button type="submit" name="submit" value="Return" class="btn btn-primary">Return</button>
      </div>
      </form>
