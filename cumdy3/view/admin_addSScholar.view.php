...
<div align="center"><h1>Adding New Student Scholarship Award  Form</h1></div>
<form class="form-horizontal" role="form" method="GET" action="addSScholar.php">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="sid" name="sid" placeholder="Enter Student_ID">
    </div>
  </div>
...
<div class="form-group">     
      <div align="center" class="col-sm-offset-3 col-sm-3  col-xs-offset-2 col-xs-4 ">
          ...
          <button type="button" class="btn btn-default" onclick="window.location='admin_award_Admin.php?tableName1=scholarship&tableName2=scholarshipdetail&tableName3=student&tableName4=studentdetail&tableName5=academic_year&id=2'">Back</button>
      </div>
</div>
