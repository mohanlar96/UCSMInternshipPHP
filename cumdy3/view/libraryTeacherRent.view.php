...
<div class="container-fluid" >    
  <div class="row">
    <div class="col-sm-offset-1 col-sm-10" id="body">
      <h3>Library > Library Teacher Rent Book </h3>
       <div class="dropdown">
 ...
 <div class="row">
 <form class="form-horizontal" role="form" method="post" action="libraryTeacherRe.php">
 <div class="form-group">
       <div class="form-group">
      <label class="control-label col-sm-2" for="uid">Teacher ID:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" name="tid" id="uid" placeholder="Enter Teacher ID">
      </div>
    </div>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control"  name="r" id="rent_date" placeholder="Enter Year/Month/Day for Rent Date" class="Date">
      </div>
    </div>
