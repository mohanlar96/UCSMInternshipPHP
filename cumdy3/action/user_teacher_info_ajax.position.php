...
require 'db_connection.php';
  ...
  echo json_encode($db_data);
  	...
  	$db_data=$db->query("select Teacher_ID,Teacher_Name from teacher join department where teacher.Department_ID=department.Department_ID and teacher.Position='$position_name' ");
  echo json_encode($db_data);
