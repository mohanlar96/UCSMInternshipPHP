...
<div class="row ">
  <div class="col-sm-2 col-xs-12">
    ...
    <ul class="catSub">
        <li><a href="admin_teacher_manage_dept.php">Manage Department</a></li>
...
<option>    </option>
    ...
    <form name="teacher_form" id="searchName" class="form-horizontal register" action="admin_teacher_info_name.php" method="post" role="form">
...
<form class="form-horizontal" role="form" name="teacher_form"  id="teacherForm" method="post"  action="admin_teacher_infoDisplay.php">
