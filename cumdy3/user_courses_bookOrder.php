...
//$you_are_here='<a herf = "user.php" id = "linkStyle">User</a> <span class = "animate">  > </span> <a herf = "user_courses_bookOrder.php" id = "linkStyle">Courses</a>';


require "view/user_courses_bookOrder.view.php";
?>